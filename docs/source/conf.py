...
Copyright
    ...
    ossl is distributed in the hope that it will be useful, but
...
version: str = '1.0'
release: str = 'https://github.com/vroncevic/ossl/releases'
